...
│   ├── data/maps/
│   │   ├── maps.json               # 地圖清單、傳送點、NPC、明雷、危險區域
│   │   ├── village.txt
│   │   └── forest.txt
│   └── assets/
│
...
```json
{
  "defaultMap": "village",
  "maps": {
    "village": { "file": "village.txt", "name": "新手村" },
    "forest": {
      "file": "forest.txt",
      "name": "幽暗森林",
      "maxVisibleEnemies": 1,
      "maxDarkEnemies": 3,
      "visibleEnemies": [
        { "id": "forest_wolf_1", "templateId": "wild_wolf", "x": 4, "y": 8, "chaseRange": 5, "loseRange": 8 }
      ],
      "dangerZones": [
        { "id": "forest_upper_thicket", "rect": { "x1": 10, "y1": 3, "x2": 14, "y2": 5 } }
      ]
    }
  },
  "teleports": {
...
| 地圖 ID | 名稱 | 說明 |
|---------|------|------|
| `village` | 新手村 | 起始區域，無明雷與危險區；傳送點 `@` (12, 6) → 森林 |
| `forest` | 幽暗森林 | 3 隻明雷、3 處危險區域（灌木叢）；傳送點 `@` (9, 3) → 新手村 |
...
|---------|------|------|--------|----------|------|------|----------|----------|
| `wild_wolf` | 野狼 | 風 | ✅ | 1～10 | ✅ | ✅ | forest | 基礎劍術、重劈 |
| `shadow_wisp` | 幽影 | 無 | ✅ | 3～12 | ✅ | ✅ | forest | 基礎法術、火球術 |
